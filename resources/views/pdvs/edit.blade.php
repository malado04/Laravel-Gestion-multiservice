...
@section('content')<br>
    <form action="{{route('pdvs.update', $pdv)}}" method="post">
        @method('PUT')
        @csrf
    <div class="row">
        <div class="col-12">
                ...
                <fieldset class="p-3 border border-info border-4">
                    ...
                    <div class="row">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nom_pdv') is-invalid @enderror" id="exampleInputName" placeholder="Nom point de vente" name="nom_pdv" value="{{$pdv->nom_pdv}}" required="">
